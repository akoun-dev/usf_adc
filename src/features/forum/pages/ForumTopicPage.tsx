...
export default function ForumTopicPage() {
    ...
    if (!topic)
        return (
            <p className="text-muted-foreground">{t("forum.topic.notFound")}</p>
        )

    const canManageTopic = currentUserId === topic.created_by || isAdmin
    const initials = (topic.author?.full_name || "A")
        .split(" ")
        .map(w => w[0])
        .join("")
        .slice(0, 2)
        ...
        <div className="space-y-6 animate-fade-in">
                    ...
                    {isEditingTopic ? (
                        <div className="space-y-3">
                            <Input
                                ...
                                placeholder={t("forum.topic.titlePlaceholder")}
                            />
                            <Textarea
                                value={editContent}
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>
                            {t("forum.topic.deleteConfirmTitle")}
                        </AlertDialogTitle>
                        <AlertDialogDescription>
