...
CREATE TRIGGER on_internal_messages_translation BEFORE INSERT OR UPDATE ON public.internal_messages FOR EACH ROW EXECUTE FUNCTION public.handle_internal_messages_translation();
