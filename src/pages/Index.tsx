...
const Footer = () => {
    const { t } = useTranslation()
    return (
        <footer className="bg-[hsl(210,30%,8%)] px-4 sm:px-6 py-10 text-white/50">
            <div className="container mx-auto max-w-6xl">
                <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 mb-8">
                    ...
                    <div>
                        <h4 className="text-white font-semibold mb-3">
                            {t("index.footer.navigation")}
                        </h4>
                        <div className="grid grid-cols-2 sm:grid-cols-1 gap-x-2 gap-y-1 text-xs">
                            <a
                                href="#features"
                                className="hover:text-white transition-colors"
                            >
                                {t("index.footer.features")}
                            </a>
                            <Link
                                to="/carte-public"
                                className="hover:text-white transition-colors"
                            ...
                            <a
                                ...
                                className="hover:text-white transition-colors"
                            >
                                {t("index.footer.about")}
                            </a>
                            <Link
                                to="/documents-publics"
                                className="hover:text-white transition-colors"
                            >
                                {t("index.footer.documents")}
                            </Link>
                            <Link
                                to="/actualites"
                                className="hover:text-white transition-colors"
                            ...
                            <Link
                                ...
                                className="hover:text-white transition-colors"
                            >
                                {t("index.footer.forum")}
                            </Link>
                            <Link
                                to="/projets"
                                className="hover:text-white transition-colors"
                            >
                                {t("index.footer.projects")}
                            </Link>
                            <Link
                                to="/calendrier"
                                className="hover:text-white transition-colors"
                            >
                                {t("index.footer.events")}
                            </Link>
                        </div>
                    </div>
                ...
                <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-center sm:text-left">
                    <p className="text-white/40">
                        {t("index.footer.copyright", {
                            year: new Date().getFullYear(),
                        })}
                    </p>
                    <div className="flex items-center justify-center sm:justify-end gap-4 text-white/40">
                        <Link
                            to="/a-propos"
                            className="hover:text-white transition-colors"
                        >
